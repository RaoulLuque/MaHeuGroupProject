...
RESULTS_BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'results', 'notable', 'tmp', "quantiles", "results/notable/tmp/quantiles/DIFF_Quantile0.5_minus_Quantile0.0"))
